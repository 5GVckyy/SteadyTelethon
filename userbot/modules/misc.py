...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/5GVckyy/SteadyUserbot"
# ============================================
...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Steady-Userbot....`")
...
async def killdabot(event):
    await event.edit("`Restarting Steady-Userbot...`")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[⚡ Steady-Userbot Repo](https://github.com/5GVckyy/SteadyUserbot/blob/aaf9fc44bedeb3bf51982e52c3eba78404b45322/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        ...
        "├‒─‒──────────‒─‒╯\n"
        "│🔰 **ᴏᴡɴᴇʀ :** [Steady](t.me/Vckyyclonee)\n"
        "╰‒─‒──────────‒─‒╯\n"
        "  𝗟𝗶𝗰𝗲𝗻𝘀𝗲 : [GPL-3.0 License](https://github.com/5GVckyy/SteadyUserbot/blob/master/LICENSE)"
    )
