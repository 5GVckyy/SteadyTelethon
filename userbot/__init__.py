...
# Untuk Perintah .steady
STEADY_TEKS_KUSTOM = os.environ.get("STEADY_TEKS_KUSTOM", None)
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Steady-Userbot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/e7bac7390186c7fc40548.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/e7bac7390186c7fc40548.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```𝘊𝘰𝘯𝘨𝘳𝘢𝘵𝘴𝘴... ⚡Steady-Userbot⚡ Has Been Active!!```")
    return
        ...
        async def opeen(event):
            try:
                ...
                if tgbotusername is not None:
                    results = await event.client.inline_query(tgbotusername, "@Steady-Userbot")
